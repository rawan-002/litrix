...
Per paper we gather independent opinions and combine them by authority:
  ...
  0. PUBLISHER DOI-PATTERN OVERRIDE (top authority, no API call; see the
     ...
     prefix (also used by legitimate LNCS/CCIS proceedings), nor to
     Frontiers' ISBN-shaped Research Topic ebook DOIs (10.3389/978-...) -
     only one such row exists in the DB, not enough evidence for a standing
     rule (see venue_classifiers/publishers.py's note on both). New publisher
