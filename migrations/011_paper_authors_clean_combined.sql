...
SELECT
    ...
    -- All authors (Al-Baha + external) without any affiliation suffix.
    -- Why: Excel export wants a single column with the full author list
    -- as it would appear under the paper title in academic databases.
    TRIM(BOTH '، ' FROM
